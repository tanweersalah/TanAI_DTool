...
docker_containers = [
    {"name": "container1", "ports": "8080:80", "status": "running", "image": "nginx:latest"},
    {"name": "container2", "ports": "3306:3306", "status": "stopped", "image": "mysql:5.7"},
    {"name": "container3", "ports": "6379:6379", "status": "running", "image": "redis:alpine"}
]
